...
if st.session_state.step == "enter_id":
    ...
    st.markdown(
        "<span style='color:#F5DD5C; font-size:30px'>Welcome to the Reflection App Demo</span>"
        "<br><br>"
        "<span style='color:#F5DD5C; font-size:16px'><em>This is an early draft of an app designed to use AI chatbot conversations for in-class goal-setting and reflection. We're looking for your honest feedback on a short reflection conversation with a chatbot."
        "<br><br>"
...
# --- STEP 2: Reflect on goal (if recent) ---
    ...
    if goal_info.get("source") == "demo":
        ...
        st.markdown(
            "<span style='color:#F5DD5C; font-size:20px'><em>Demo Mode! This is an imaginary exercise for testing. "
        ...
        st.markdown("<span style='color:#F5DD5C; font-size:24px'><strong>Imagine you are the following test persona:</strong></span>", unsafe_allow_html=True)
        st.markdown(f"<span style='color:#F5DD5C'><strong>Your name is:</strong> {nickname}</span>", unsafe_allow_html=True)
        st.markdown(f"<span style='color:#F5DD5C'><strong>Your most recent goal is:</strong> {goal_info.get('text', '[no goal]')}</span>", unsafe_allow_html=True)
        st.markdown(f"<span style='color:#F5DD5C'><strong>Some background that the system knows about you:</strong> {background}</span>", unsafe_allow_html=True)
    ...
    st.markdown(
        "<span style='color:#F5DD5C'><em>(Choose any number below. This will affect your AI-Reflection Conversation.)</em></span>",
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        "<span style='color:#F5DD5C'><em>(For 3 or 4, use the question below to imagine what helped. For 1 or 2, imagine what got in the way.)</em></span>",
        unsafe_allow_html=True
    )
...
#  --- Chatbot motivational step---
    ...
    # --- Turn 3: Wrap up ---
        ...
        # 🟨 Feedback context
        st.markdown(
            "<span style='color:#F5DD5C'><strong>This was just a sample reflection, but we still want your honest feedback.</strong><br>"
